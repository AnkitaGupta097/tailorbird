...
const columns = [
    ...
    { name: "suppliers", label: "Supplier", flex: 2 },
...
const PackageDataTable: React.FC<IPackageSpaceProps> = (props: IPackageSpaceProps) => {
    const imageStyle = {
        height: "2.175rem",
        width: "2.175rem",
        display: "block",
    ...
    const { skuRows, setPackageSelectedCount, onSupplierChange } = props;
    useEffect(() => {
                        ...
                        <TableRow>
                            ...
                            {columns.map((column) => (
                                <TableCell
                                    ...
                                    size={column.name === "suppliers" ? "medium" : "small"}
                                >
                        ...
                        {props.skuRows.map((sku, index) => (
                            ...
                            >
                                ...
                                {columns.map((column) => {
                                    ...
                                    const value = sku[name as keyof typeof sku];
                                    let component: any = null;
                                    if (column.name === "suppliers")
                                        component = sku.material_id ? (
                                            <BaseAutoComplete
                                                options={value as unknown as Array<any>}
