...
interface IRenoWizard extends IRenovationWizard {
    loading: boolean;
    getUploaderName?: any;
}

const RenoWizard = (renovationWizard: IRenoWizard) => {
            ...
            <Accordion elevation={0}>
                ...
                <AccordionDetails>
                    <FileUpload
                        ...
                        helperText="Accepts .doc, .pdf and .xlsx only"
