...
export const RFP_TABS = (isBidSetup: boolean) => {
    return [
        {
            label: "Contractors",
            value: "/contractors",
...
const FLOOR_PLAN_DATA = {
    ...
    type: "",
    area: "",
    // commented since reno_scope was no more accepted on BE
    // reno_scope: "",
    total_units: "",
    reno_units: "",
    autodesk_url: "",
...
const PROJECT_CONTAINER_VERSIONS = ["1.0", "2.0"];
