...
const BillingDialog: React.FC<IBillingDialog> = ({ open, setOpen, onProceed, opportunityId }) => {
                ...
                <DialogContent sx={{ padding: "2rem 4rem" }}>
                    <Stack height="100%" justifyContent="center" alignItems="center">
                        ...
                        <Typography
                            ...
                            textAlign="center"
                        >
                            Please enter the Opportunity id for this project
                        </Typography>
                        <BaseTextField
                            variant={"outlined"}
                            sx={{ marginBottom: "20px" }}
                    ...
                    <Stack direction="row" justifyContent="center" gap={"15px"}>
                        ...
                        <BaseButton
                            ...
                            disabled={field !== opportunityId || opportunityId === ""}
